...
<div class="row">
    <div class="pull-right">
        ...
        <input type="hidden" id="edit" value="{{route('form_why_us')}}?id=">
    </div>
          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
           <!--  <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%"> -->
                ...
                <tbody>
                   ...
                   <tr>
                       <td>{{$no}}</td>
                       <td><img src="{{asset('/public/images/why_us/'.$row->img)}}" class="img-responsive" alt="" style="width: 200px" ></td>
                       <td>{{$row->title}}</td>  
...
function edit(sid){
  ...
  function deleted(sid){    
    ...
    var url   = url_delete+sid+"&table=t_why_us&refresh=why_us";
