...
<div class="box box-info" >
    <div class="box-header with-border">
        <div class="row">
            ...
            <input type="hidden" id="url_back" value="{{ route('slideshow') }}">
            <input type="hidden" id="id" value="{{ $id }}">
            <input type="hidden" id="url_upload" value="{{route('upload_file') }}?folder=">
            <input type="hidden" id="url_save" value="{{route('slideshow_add') }}?id=">
        </div>
    </div>
    <div class="box-body">
            ...
            <div class="panel panel-info">
               <div class="form-group" >
                   <label for="img" class="col-sm-3 control-label1">Image</label>
                        <div class="col-sm-9">
                           <img class="img-thumbnail upload_file" width="200" height="200" id="profile-pre" name="upload_file" src="@if($id>0){{asset('public/images/banner/'.$get['img'])}}@else{{asset('public/img/df.jpg')}}@endif" alt="your image" />
...
function SaveWarning(){
    ...
    var url_upd     = $('#url_upload').val();
      // config Uoload
    var folder      = 'banner';//folder untuk input gambar
    ...
    var refresh     = 'slideshow';// url untuk reload page setelah input data
