...
<div class="row">
   ...
   <div class="container white-container">
    ...
    <div class="row">
        <div class="col-md-6">
            <h3 class="head-title"><span class="glyphicon glyphicon-play"></span> Edit Group User</h3>
        </div>
    ...
    <form action="{{ route('level_users.update',$level_users['id']) }}" method="post" class="form-horizontal">
        {{ csrf_field() }}
        {{ method_field('PUT')}}
    ...
    <div class="form-group {{ $errors->has('level') ? ' has-error' : '' }}">
        ...
        <div class="col-md-4">
            <input type="number" name="level" value="{{ $level_users['level'] }}" class="form-control" id="level" autofocus="autofocus"/>
            @if ($errors->has('level'))
    ...
    <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
        ...
        <div class="col-md-4">
            <input type="text" name="description" value="{{ $level_users['description'] }}" class="form-control" id="description" autofocus="autofocus"/>
