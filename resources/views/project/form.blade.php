...
<div class="box box-info" >
    <div class="box-header with-border">
        <div class="row">
            ...
            <input type="hidden" id="url_back" value="{{ route('project') }}">
            <input type="hidden" id="id" value="{{ $id }}">
            <input type="hidden" id="url_upload" value="{{route('upload_file') }}?folder=">
            <input type="hidden" id="url_save" value="{{route('project_add') }}?id=">
        </div>
    </div>
    <div class="box-body">
            ...
            <div class="panel panel-info">
               <div class="form-group" >
                   <label for="img" class="col-sm-3 control-label1">Image</label>
                        <div class="col-sm-9">
                           <img class="img-thumbnail upload_file" width="200" height="200" id="profile-pre" name="upload_file" src="@if($id>0){{asset('public/images/project/'.$get['img'])}}@else{{asset('public/img/df.jpg')}}@endif" alt="your image" />
...
function SaveWarning(){
    ...
    var url_upd     = $('#url_upload').val();
      // config Uoload
    var folder      = 'project';//folder untuk input gambar
    var table       = 't_past_project';//table database
    var field_name  = 'img';//nama field database yang akan di input
    var obj_id      = 'profile-id';//nama id file input gambar/file
    var refresh     = 'project';// url untuk reload page setelah input data
