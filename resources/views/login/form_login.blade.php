 ...
 <form class="form-horizontal" action="{{ route('login') }}" method="post">
    ...
    <div class="form-group m-b-20 {{ $errors->has('email') ? ' has-error' : '' }}">
        <div class="col-xs-12">
            ...
            <input class="form-control" type="email" id="email" name="email" value="{{ old('email') }}" placeholder="john@deo.com">
            @if ($errors->has('email'))
    ...
    <div class="form-group m-b-20 {{ $errors->has('password') ? ' has-error' : '' }}">
        <div class="col-xs-12">
            ...
            <span  onclick="show_password()" class="fa fa-fw fa-eye field-icon toggle-password"></span>
